...
//SHRUGS
function resolveShrugs() {
    const shrugsOn = document.getElementById("shrugsOn").value;
    ...
    if (shrugsOn == 6) {
        ...
        if (shrugsOn >= 4 && shrugsOn <= 6) {
            unshrugged = avgResult;
        }

    //console.log("unshrugged: " + unshrugged);
}
...
function displayDetails() {
    ...
    if (displayDetails.length === 1) {
        ...
        if (unshrugged !== null) {
            document.getElementById("shrugRollDetails").innerHTML = unshrugged.toFixed(2) + " unshrugged wounds expected"
        }
    }
    ...
    if (displayDetails.length === 0) {
        ...
        document.getElementById("shrugRollDetails").innerHTML = "";
    }
}
